                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="item wow fadeIn" data-wow-delay=".6s">
                      <div className="content">
                        <div className="tags">
                          <Link href="/blog/blog-dark">Tendencia 2022</Link>
                        </div>
                        <div className="info">
                          ...
                          <a href="#0">Por Augusto araújo</a>
                        </div>
                        <div className="title">
                          <h4>
                            <Link href="/blog-details/blog-details-dark">
                            Crie o estilo de vida que você realmente deseja neste mundo
                            </Link>
                          </h4>
                        </div>
                        <div className="text">
                          <p>
                          O sucesso não é por acaso. É um trabalho árduo,
                            perseverança, aprendizado, estudo, sacrifício e mais
                            acima de tudo, amor pelo que você está fazendo.
                          </p>
                        </div>
                        <div className="more">
                          <Link href={`/blog-details/blog-details-dark`}>
